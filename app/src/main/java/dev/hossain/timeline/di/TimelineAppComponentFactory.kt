...
class TimelineAppComponentFactory : AppComponentFactory() {
  ...
  override fun instantiateActivityCompat(
    ...
    return getInstance(classLoader, className, activityProviders)
   ...
   */
  override fun instantiateApplicationCompat(classLoader: ClassLoader, className: String): Application {
